...
if __name__ == "__main__":
  with app.app_context():
    ...
    installation5 = Installation(name="Golden Pheasant in the Snow", image_url="../src/assets/GoldenPheasantintheSnow.jpg", description="Jakuchū  expressed snow by using whitewash on the front and back, and thin black ink applied to the painting silk. It is a work in which a fantasy world is vividly depicted with intense colors.", artist_id=artist5.id, exhibit_id=exhibit3.id)
    installation6 = Installation(name="Fur Traders Descending the Missouri", image_url="../src/assets/FurTradersDescending.jpg", description=" Bingham, who began his career as a portraitist, produced this distinctive genre painting with little precedent in his oeuvre. The tranquil scene, with its luminous atmosphere, idealized the American frontier for the benefit of an Eastern audience.", artist_id=artist6.id, exhibit_id=exhibit2.id)
